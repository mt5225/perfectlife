(function() {
  exports.ArticleMsgMap = {
    ...
    'V1002_AGH_1': {
      ...
      url: 'http://qa.aghchina.com.cn:9000/#/housedetail/H001'
    },
    'V1002_AGH_2': {
      title: '向日葵',
      description: '向日葵营地，正如它的花语---勇敢去追求自己想要的幸福。如果...',
      picurl: 'http://aghpic.oss-cn-shenzhen.aliyuncs.com/wechatapp/xrk.jpg',
      url: 'http://qa.aghchina.com.cn:9000/#/housedetail/H002'
    },
    'V1002_AGH_3': {
      title: '绿茶',
      description: '远离城市浮华，步入大自然的怀抱，在上水之间寻找内心的自我...',
      picurl: 'http://aghpic.oss-cn-shenzhen.aliyuncs.com/wechatapp/greentea.jpg',
      url: 'http://qa.aghchina.com.cn:9000/#/housedetail/H003'
    },
    'subscribe': {
      title: '欢迎进入漫生活',
      description: '那株久远到无法考证年代的香樟树，那湾清澈可见底的涓涓溪水，那抹夜色中的草长莺飞衍生野趣。点击进入漫生活 ...',
      picurl: 'http://aghpic.oss-cn-shenzhen.aliyuncs.com/wechatapp/%E7%9F%B3%E8%88%8D%E9%A6%99%E6%A8%9Fwith%20name.jpg',
